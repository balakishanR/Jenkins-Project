...
<body>
    ...
    <nav>
        <div class="navbar">
            ...
            <div class="media-icons">
                <a href="https://www.facebook.com/balakishan.renjarla" target="_blank"><i class="fab fa-facebook-f"></i></a>
                <a href="https://www.instagram.com/brown__yung/" target="_blank"><i class="fab fa-instagram"></i></a>
    ...
    <section class="home" id="home">
        <div class="home-content">
            ...
            <div class="button">
                <a href="https://www.linkedin.com/in/balakishanrenjarla/"><button>Hire Me</button></a>
            </div>
        </div>
    </section>
    ...
    <section class="about" id=about>
        <div class="content">
            ...
            <div class="about-details">
                <div class="left">
                    <img src="Images/profile_img.jpg" alt="Portfolio">
                </div>
                <div class="right">
                    <div class="topic">Designing Is My Passion</div>
                    <p>"I design and develop experiences that make people's lives simple."</p>
                    <div class="button">
                        <a href="https://drive.google.com/file/d/1AXBRcgNvlpMeFMIj1IsOOlDx6gNrBVX6/view?usp=sharing"><button>Download CV</button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="skills-details">
                <div class="text">
                    ...
                    <p>Responsive Web Design always plays important role whenever going to promote your website.</p>
    ...
    <section class="contact" id="contact">
        <div class="content">
            ...
            <div class="text">
                ...
                <p></p>
                <div class="button">
                    <a href="#"><button>Let's Chat</button></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer>
        <div class="text">
            <span>Created By <a href="#">BalakishanRenjarla</a> | &#169; 2021 All Rights Reserved.</span>
        </div>
    </footer>
